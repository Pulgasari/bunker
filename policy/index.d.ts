...
export interface PolicyEntry<T = unknown> {
...
export interface PolicyOptions {
   ...
   */
  max?: number;
  /** L2 entry ceiling, enforced by {@link Policy.prune}, oldest first. `0` disables it. */
  maxEntries?: number;
  namespace?: string;
...
export interface Policy {
  ...
  entry<T = unknown>(key: string): Promise<PolicyEntry<T>>;
...
export declare function createPolicy(options?: PolicyOptions): Policy;
